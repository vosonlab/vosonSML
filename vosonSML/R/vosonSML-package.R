...
#' sources (twitter, youtube, and reddit) and generating different types of networks suited to Social Network Analysis 
#' (SNA) and text analytics. It offers tools to create unimodal, multimodal, and semantic networks. It draws on 
#' excellent packages such as \pkg{rtweet}, \pkg{RedditExtractoR} and \pkg{igraph} in order to provide an integrated 
#' 'work flow' for collecting different types of social media data and creating different types of networks out of 
#' these data. Creating networks from social media data is often non-trivial and time consuming. This package 
#' simplifies such tasks so users can focus on analysis.
#'
...
#' \code{dataSource} objects are assigned a class identifying the source of data, e.g. \code{twitter} or

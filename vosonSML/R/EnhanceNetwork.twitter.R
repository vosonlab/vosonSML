...
#'
#' @param dfCollect A dataframe containing the collected tweet data from \code{Collect}.
#' @param dfRelations A dataframe containing the network relations data from \code{Create}.
#' @param dfUsers A dataframe containing the network users data from \code{Create}.
...
#'
#' @export
EnhanceNetwork.twitter <- function(dfCollect, dfRelations, dfUsers, lookupMissingUsers = TRUE, 

...
#' @param videoIds List. Video ID's to lookup. 
...
#' @export
AddVideoData <- function(net, youtubeAuth = NULL, videoIds = NULL, ...) {
...
#' @noRd
#' @export
AddVideoData.default <- function(net, youtubeAuth = NULL, videoIds = NULL, ...) {
...
#' @export
AddVideoData.actor <- function(net, youtubeAuth = NULL, videoIds = NULL, ...) {
...
#' @noRd
#' @export
AddVideoData.actor.default <- function(net, youtubeAuth = NULL, videoIds = NULL, ...) {
  stop("Unknown social media type passed to addvideodata.", call. = FALSE)
}

#' @title Add columns of video information to youtube actor network dataframes
#'

...
Create.actor.twitter <- function(datasource, type, verbose = TRUE, ...) {
  ...
  df_stats <- network_stats(df_stats, "quoting others", count, TRUE)
  ...
  df_stats <- network_stats(df_stats, "reply mentions", rmcount, TRUE)
  ...
  df_stats <- network_stats(df_stats, "edges", sum(df_stats$count[df_stats$edge_count == TRUE]))
